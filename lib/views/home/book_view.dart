...
class _BookPageState extends State<BookPage> {
  ...
  Future<void> _loadDocument() async {
    try {
      final ByteData data = await rootBundle.load('assets/pdf/MIRATHI.pdf');
      final Uint8List bytes = data.buffer.asUint8List();
      final tempDir = await getTemporaryDirectory();
      final tempDocumentPath = '${tempDir.path}/document.pdf';
      final File file = File(tempDocumentPath);
      await file.writeAsBytes(bytes);

      if (mounted) {
        setState(() {
          _documentPath = tempDocumentPath;
        });
      }
    } catch (e) {
        ...
        children: [
            ...
            NotificationListener<ScrollNotification>(
              onNotification: (ScrollNotification scrollInfo) {
                if (scrollInfo.metrics.axis == Axis.vertical) {
                  _updateProgress(scrollInfo.metrics.pixels /
          ...
          Align(
            ...
            child: Padding(
              ...
              child: FloatingActionButton(
                heroTag: 'previousChapter', // Unique Hero tag
          ...
          Align(
            ...
            child: Padding(
              padding: const EdgeInsets.all(20),
              child: FloatingActionButton(
                heroTag: 'nextChapter', // Unique Hero tag
                backgroundColor: Color(0xFFD76D2C),
          ...
          Align(
            ...
            child: Padding(
              ...
              child: FloatingActionButton(
                heroTag: 'showChapters', // Unique Hero tag
                backgroundColor: Color(0xFFD76D2C),
